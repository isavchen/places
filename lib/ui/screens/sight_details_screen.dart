...
import 'package:places/bloc/place_details_screen/place_details_screen_bloc.dart';
...
class _SightDetailsScreenState extends State<SightDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<PlaceDetailsScreenBloc>(
      create: (context) =>
          PlaceDetailsScreenBloc(context.read<PlaceInteractor>())
            ..add(LoadPlaceDetails(id: widget.sightId)),
      child: Scaffold(
        body: OverscrollGlowAbsorber(
          child: SafeArea(
            child: BlocBuilder<PlaceDetailsScreenBloc, PlaceDetailsScreenState>(
              builder: (context, state) {
                if (state is PlaceDetailsScreenLoadingState) {
                  return Center(
                ...
                } else if (state is PlaceDetailsScreenErrorState) {
                  return Center(child: ErrorPlaceholderScreen());
                } else if (state is PlaceDetailsScreenSuccessState) {
                ...
                throw ArgumentError('Wrong state in SightDetailsScreen');
              },
            ),
          ),
        ),
